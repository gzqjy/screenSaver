...
VIAddVersionKey /LANG=${LANG_SimpChinese} "CompanyName" "中科嘉速（北京）信息技术有限公司"
VIAddVersionKey /LANG=${LANG_SimpChinese} "LegalCopyright" "Copyright (c) 2025 中科嘉速（北京）信息技术有限公司"
